...
if __name__ == "__main__":
    ...
    model_path  = "logs/ep060-loss0.242-val_loss0.201.pth"
    #-----------------------------------------------------#
    ...
    #   读取数据集对应的txt
    #---------------------------#
    with open(os.path.join(VOCdevkit_path, "NEU_Seg-main/imageclass/train.txt"),"r") as f:
        train_lines = f.readlines()
    with open(os.path.join(VOCdevkit_path, "NEU_Seg-main/imageclass/val.txt"),"r") as f:
