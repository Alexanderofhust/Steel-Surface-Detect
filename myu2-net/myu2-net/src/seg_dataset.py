...
class U2netSegDataset(Dataset):
    def __init__(self, img_dir, mask_dir, input_size=(200, 200)):
        """
    ...
    def load_data(self):
        ...
        for img_name in tqdm(img_files):
            ...
            mask_full_path = os.path.join(mask_dir_full_path, os.path.splitext(img_name)[0]+'.png')
            print(img_full_path)
...
if __name__ == '__main__':
        ...
        train_dataset = U2netSegDataset(img_dir=os.path.join(o,'dataset', 'images', 'test'),
                                        mask_dir=os.path.join('E:\\ai\\myu2-net','dataset', 'masks', 'test'),
                                        input_size=(200, 200))
        U2netSegDataset.load_data(train_dataset)
'''