...
try:
    ...
    checkpoint_path = os.path.join(current_project_path,
                                   'backup\\1.pth')  # os.path.join(current_project_path, 'backup\\u2netp
    '''
...
def inference1folder(img_folder, mask_folder, input_size):
    ...
    for img_file in tqdm(img_files):
        ...
        mask_full_path = os.path.join(mask_folder, os.path.splitext(img_file)[0]+'.png')
